...
participant Relayer
participant forwarder as "Trusted\nForwarder\nContract"
participant recipient as "Recipient\nContract"
client->Relayer: signed request
Relayer->forwarder: sendAndVerify(request)
note over forwarder: verify signature
group This is the scope of the ERC
forwarder->recipient: execute\n(with client-addr appended)
activate recipient
recipient->recipient: _msgSender()
note right of recipient: check msg.sender,\nextract client addr
activate recipient
